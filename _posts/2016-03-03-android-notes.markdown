...
private void checkPermission() {  
    int storagePermission = ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE\_EXTERNAL\_STORAGE);  
    String[]() reqPermissonList = {Manifest.permission.WRITE\_EXTERNAL\_STORAGE};  
...
public void onRequestPermissionsResult(int requestCode, String[]() permissions, int[]() grantResults) {  
    switch (requestCode) {  
        case REQUEST\_WRITE\_PERMISSION\_CODE: {  
            for (int i = 0; i \< permissions.length; i++) {  
                if (grantResults[i]() == PackageManager.PERMISSION\_GRANTED) {  
                    startCameraIntent();  
                    Log.d("Permissions", "Permission Granted: " + permissions[i]());  
                } else if (grantResults[i]() == PackageManager.PERMISSION\_DENIED) {  
...
[10]:	http://apps.wandoujia.com/redirect?signature=e3f9891&url=http://shouji.360tpcdn.com/140404/ab6403ea7dfea7715265e25f1c19cff1/net.atredroid.videotogif_23.apk&pn=net.atredroid.videotogif&md5=ab6403ea7dfea7715265e25f1c19cff1&apkid=10172992&vc=23&size=9947938&pos=t/detail&tokenId=sspai&appType=APP "豌豆荚"